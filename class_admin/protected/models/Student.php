...
class Student extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			// dorm_id
			array('student_id, student_name, address, phone, email,birthday, student_info, login_name, login_psw, class_id, major_id, is_check', 'required'),
			...
			array('student_id, student_name, address, phone, email, dorm_id, birthday, student_info, login_name, login_psw, class_id, major_id, is_check', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'announce_clicks' => array(self::HAS_MANY, 'AnnounceClick', 'student_id'),
			...
			'competitor' => array(self::HAS_MANY, 'Competitor', 'student_id'),
		);
	}
