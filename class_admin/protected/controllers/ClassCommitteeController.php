...
class ClassCommitteeController extends Controller
{
	...
	{
		$model=new ClassCommittee;
		if(isset($_POST['ClassCommittee']))
		{
			$model->attributes=$_POST['ClassCommittee'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('ClassCommittee');
	...
	{
		$model=new ClassCommittee('search');
		$model->unsetAttributes();  // clear any default values
		$model -> class_id = Yii::app() -> user -> class_id;
		if(isset($_GET['ClassCommittee']))
			$model->attributes=$_GET['ClassCommittee'];
	 ...
	 * @param ClassCommittee $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='class-committee-form')
		{
