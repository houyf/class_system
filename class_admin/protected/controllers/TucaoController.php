...
class TucaoController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Tucao');
	...
	{
		$model=new Tucao('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tucao']))
			$model->attributes=$_GET['Tucao'];
	 ...
	 * @param Tucao $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tucao-form')
		{
