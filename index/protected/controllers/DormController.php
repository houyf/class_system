...
class DormController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view', 'GetDorms'),
				'users'=>array('*'),
			),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Dorm']))
		{
			$model->attributes=$_POST['Dorm'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->dorm_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Dorm');
	...
	{
		$model=new Dorm('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Dorm']))
			$model->attributes=$_GET['Dorm'];
	 ...
	 * @param Dorm $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='dorm-form')
		{
